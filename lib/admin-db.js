...
// -------- PRODUITS --------
export function getAdminProducts(){ return products; }
export function getAdminProduct(id){ return products.find(p=>p.id===id)||null; }
...
// -------- COMMANDES --------
export function getAdminOrders(){ return orders; }
export function getAdminOrder(id){ return orders.find(o=>o.id===id)||null; }
